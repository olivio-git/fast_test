interface PropsButton {
  ...
  export const ButtonCiudadania = ({ onPress,text }: PropsButton) => {
    return (
      <button
        type="button"
        onClick={onPress}
        className="flex justify-center bg-primary inline-block rounded px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal 
